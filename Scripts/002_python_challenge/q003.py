...
Source : http://www.pythonchallenge.com/pc/def/equality.html
...
xaUxEjKNBUXkttDUxfvWGqyfznxUs
TVAVGWtcdngzeQtkZFHFSPWNkaTdiouHQtDsgBFqXzXqKTQlaqI
...
rx = re.compile("[a-z][A-Z][A-Z][A-Z]([a-z])[A-Z][A-Z][A-Z][a-z]")
print("".join(rx.findall(text)))
